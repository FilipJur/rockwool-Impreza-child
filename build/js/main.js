...
/***/ "./src/js/modules/woocommerce-integration.js":
/*!***************************************************!*\
  !*** ./src/js/modules/woocommerce-integration.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WooCommerceIntegration: () => (/* binding */ WooCommerceIntegration)
/* harmony export */ });
/* harmony import */ var _utils_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/api.js */ "./src/js/utils/api.js");
/**
...
class WooCommerceIntegration {
  ...
  observeMinicartChanges() {
    const minicartSelectors = ['.widget_shopping_cart_content', '.woocommerce-mini-cart', '.cart-contents', '.mini-cart', '.wc-block-mini-cart'];
  ...
  async getCartState() {
    try {
      const response = await _utils_api_js__WEBPACK_IMPORTED_MODULE_0__.api.wpAjax('mycred_get_cart_state', {});
      if (response.success) {
  ...
  getProductIdFromButton(button) {
    ...
    if (productContainer) {
      productId = productContainer.getAttribute('data-product-id') || productContainer.getAttribute('data-id');
      if (productId) return parseInt(productId);
    }
    return null;
  }
...
/* harmony import */ var _modules_woocommerce_integration_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/woocommerce-integration.js */ "./src/js/modules/woocommerce-integration.js");
/**
...
class ThemeApp {
  ...
  initializeModules() {
    ...
    if (document.querySelector('.woocommerce, .add_to_cart_button') || typeof wc_add_to_cart_params !== 'undefined') {
      try {
        this.modules.wooCommerceIntegration = new _modules_woocommerce_integration_js__WEBPACK_IMPORTED_MODULE_2__.WooCommerceIntegration();
        console.log('WooCommerce integration initialized');
      } catch (error) {
